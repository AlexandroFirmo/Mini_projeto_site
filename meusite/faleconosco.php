<div class="container">
	<div class="col-md-6">
		<form id="contactForm" action="" method="post">
			...
			<label>Assunto: </label><input type="text" class="form-control" name="assunto"/><br>
			<label>Mensagem:</label> <textarea name="mesagem" class="form-control" rows="5" cols="10" name="nome"/></textarea><br>
